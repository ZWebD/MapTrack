...
class App {
  ...
  _renderWorkout(workout, add = true, edit = false) {
    let html = `
  ...
  _editWorkout(e) {
    ...
    const attributeKeys = Object.keys(workout).slice(4, 8);
    ...
    // editForm
    //   .querySelector(`.form__input--distance`)
    //   .setAttribute(
    //     `placeholder`,
    //     `${workout.distance} ${editForm
    //       .querySelector(`.form__input--distance`)
